...
Panel {
  ...
  // Night light service, same API the standalone indicator uses.
  ...
  function sectionCount(section) {
    ...
    if (section === "nightlight") return 1
  ...
  function activateCursor() {
    ...
    if (focusSection === "nightlight" && selectedIndex === 0) {
      ...
      ScrollView {
        ...
        Column {
          ...
          Column {
            ...
            Item {
              width: parent.width
              implicitHeight: Math.max(nightlightHeader.implicitHeight, nightlightState.implicitHeight)
              ...
              Text {
                id: nightlightState
                textFormat: Text.PlainText
                text: root.nightlightService && root.nightlightService.enabled ? "ON" : "OFF"
                color: Qt.darker(root.bar.foreground, 1.4)
                font.family: root.bar.fontFamily
                font.pixelSize: Style.font.caption
                font.bold: true
            ...
            CursorSurface {
              id: nightlightRow
              width: parent.width
              implicitHeight: nightlightInner.implicitHeight + Style.spacing.xl
              hasCursor: root.cursorActive && root.focusSection === "nightlight" && root.selectedIndex === 0
              ...
              Row {
                ...
                Text {
                  text: root.nightlightService && root.nightlightService.enabled ? "󰔎" : "󰔐"
                  color: root.bar.foreground
                  font.family: root.bar.fontFamily
                  font.pixelSize: Style.font.title
                ...
                Text {
                  textFormat: Text.PlainText
                  text: root.nightlightService && root.nightlightService.enabled ? "Night mode active" : "Day mode"
                  color: root.bar.foreground
                  font.family: root.bar.fontFamily
